...
def draw_variance(file_path, mycolor, plot_label):  # 给一个文件地址，然后画出其文件对应的折线图，并指定颜色
    ...
    for i in range(lines):
        ...
        # variance_up3.append(up3)
        # variance_down3.append(down3)
    ...
    # average3 = data_smooth(average3)
    # variance_up3 = data_smooth(variance_up3)
    # variance_down3 = data_smooth(variance_down3)
    ...
    # axes[2].plot(episode, average3, color=mycolor, label=plot_label)
    # axes[2].fill_between(episode, variance_down3, variance_up3, facecolor=mycolor, alpha=0.3)
    # axes[2].legend(loc=0, prop=font1)
    # axes[2].grid(True)
    # axes[2].set_title('sum of squares of error')
